      ...
      <div className="max-w-5xl mx-auto flex flex-col items-center pt-20 pb-20">
        ...
        <div className="text-center mb-12 animate-fade-in">
          ...
          <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-6">
            Verify the <span className="gradient-text">Integrity</span> <br />
            of any Research Paper.
          </h1>
          <p className="text-gray-400 text-lg max-w-2xl mx-auto leading-relaxed">
            Upload a PDF or paste text to perform deep analysis on methodology,
            citation legitimacy, and logical consistency using Gemini 1.5 Pro.
          </p>
        </div>
          ...
          <div className="flex border-b border-gray-800 bg-gray-900/50">
            <button
              ...
              className={cn(
                ...
                uploadMode === "file" ? "border-indigo-500 text-white bg-indigo-500/5" : "border-transparent text-gray-500 hover:text-gray-300"
              )}
            >
              Upload PDF
            </button>
            <button
              ...
              className={cn(
                "flex-1 py-4 text-sm font-medium transition-colors border-b-2",
                uploadMode === "text" ? "border-indigo-500 text-white bg-indigo-500/5" : "border-transparent text-gray-500 hover:text-gray-300"
              )}
            >
              Paste Text
            </button>
            ...
            {uploadMode === "file" ? (
              <div
                ...
                className={cn(
                  ...
                  isDragActive ? "border-indigo-500 bg-indigo-500/5" : "border-gray-800 hover:border-gray-700 hover:bg-white/[0.02]"
                )}
              >
                <input
                  type="file"
                ...
                <div className="w-16 h-16 rounded-2xl bg-gray-800 flex items-center justify-center mb-4 text-gray-400 group-hover:scale-110 group-hover:text-indigo-400 transition-all duration-300">
              ...
              <div className="space-y-4">
                <textarea
                  ...
                  className="w-full h-64 bg-transparent border-gray-800 resize-none p-4 placeholder:text-gray-600 focus:border-indigo-500/50 transition-colors"
                />
                <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-4xl mt-12">
          {[
            ...
            <div key={i} className="glass-card p-6 border border-gray-800/50">
